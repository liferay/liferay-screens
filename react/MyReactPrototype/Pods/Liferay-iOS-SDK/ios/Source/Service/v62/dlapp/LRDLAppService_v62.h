...
- (NSOperation *)addTempFileEntryWithGroupId:(long long)groupId folderId:(long long)folderId fileName:(NSString *)fileName tempFolderName:(NSString *)tempFolderName file:(LRUploadData *)file mimeType:(NSString *)mimeType error:(NSError **)error;
