...
namespace ShowcaseAndroid
{
    ...
    public class DDLListActivity : Activity, IBaseListListener
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            DDLListScreenlet ddlListScreenlet = 
                (DDLListScreenlet) FindViewById(Resource.Id.ddl_list_screenlet);
        ...
        {
            Android.Util.Log.Debug("DDLListScreenlet", $"DDLList error: {p0.Message}");
        }
        ...
        {
            Android.Util.Log.Debug("DDLListScreenlet", $"DDLList page failed: {p1.Message}");
        }
