...
namespace ShowcaseAndroid
{
    ...
    public class PdfDisplayActivity : Activity, IAssetDisplayListener
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            PdfDisplayScreenlet pdfDisplayScreenlet = (PdfDisplayScreenlet)FindViewById(Resource.Id.pdf_display_screenlet);
		...
		{
            System.Diagnostics.Debug.WriteLine($"Pdf display succes: {p0.EntryId}");
		}
    }
}
