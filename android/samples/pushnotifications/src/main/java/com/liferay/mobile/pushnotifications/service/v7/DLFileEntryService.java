...
public class DLFileEntryService extends BaseService {
	...
	public JSONArray getFileEntries(long groupId, long folderId, int status, int start, int end, JSONObjectWrapper obc) throws Exception {
		...
		try {
			...
			_params.put("end", end);
			mangleWrapper(_params, "obc", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.document.library.kernel.model.DLFileEntry>", obc);
	...
	public JSONArray getGroupFileEntries(long groupId, long userId, long repositoryId, long rootFolderId, JSONArray mimeTypes, int status, int start, int end, JSONObjectWrapper obc) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getGroupFileEntriesCount(long groupId, long userId, long repositoryId, long rootFolderId, JSONArray mimeTypes, int status) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Boolean isKeepFileVersionLabel(long fileEntryId, boolean majorVersion, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject updateStatus(long userId, long fileVersionId, int status, JSONObjectWrapper serviceContext, JSONObject workflowContext) throws Exception {
		JSONObject _command = new JSONObject();
