...
;(function () {
  ...
  (function () {
    var modules = {}, // Stack of moduleIds currently being built.
        requireStack = [], // Map of module ID -> index into requireStack of modules currently being built.
        inProgressModules = {}, SEPARATOR = ".";
  ...
  define("cordova", function (require, exports, module) {
    ...
    var cordova = {
      ...
      getOriginalHandlers: function () {
        return {
          'document': {
            'addEventListener': m_document_addEventListener, 'removeEventListener': m_document_removeEventListener
          },
  ...
  define("cordova/argscheck", function (require, exports, module) {
    ...
    var typeMap = {
      'A': 'Array', 'D': 'Date', 'N': 'Number', 'S': 'String', 'F': 'Function', 'O': 'Object'
    };
    ...
    function checkArgs(spec, functionName, args, opt_callee) {
      ...
      if (errMsg) {
        ...
        errMsg = 'Wrong type for parameter "'
  ...
  define("cordova/channel", function (require, exports, module) {
    ...
    var Channel = function (type, sticky) {
       ...
       */
      deviceReadyChannelsArray: [], deviceReadyChannelsMap: {},
  ...
  define("cordova/exec", function (require, exports, module) {
     ...
     */
    var cordova = require('cordova'), nativeApiProvider = require('cordova/android/nativeapiprovider'),
        utils = require('cordova/utils'), base64 = require('cordova/base64'), channel = require('cordova/channel'),
        jsToNativeModes = {
          PROMPT: 0, JS_OBJECT: 1
        }, nativeToJsModes = {
          // Polls for messages using the JS->Native bridge.
          POLLING: 0, // For LOAD_URL to be viable, it would need to have a work-around for
          // the bug where the soft-keyboard gets dismissed when a message is sent.
          LOAD_URL: 1, // For the ONLINE_EVENT to be viable, it would need to intercept all event
          // listeners (both through addEventListener and window.ononline) as well
          // as set the navigator property itself.
          ONLINE_EVENT: 2, EVAL_BRIDGE: 3
        }, jsToNativeBridgeMode,  // Set lazily.
        nativeToJsBridgeMode = nativeToJsModes.EVAL_BRIDGE, pollEnabled = false, bridgeSecret = -1;
  ...
  define("cordova/modulemapper_b", function (require, exports, module) {
    ...
    var builder = require('cordova/builder'), symbolList = [], deprecationMap;
