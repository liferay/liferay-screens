<#if entries?has_content>
	...
	<div class="flex-container item-last-changes" data-class-name="${assetRenderer.getClassName()}" data-extension="blog" data-id="${entry.getAssetRenderer().getClassPK()}">
    ...
    <#elseif assetRenderer.getClassName() == 'com.liferay.document.library.kernel.model.DLFileEntry'>
        <div class="flex-container item-last-changes" data-class-name="${assetRenderer.getClassName()}" data-extension="${entry.getAssetRenderer().getAssetObject().getExtension()}" data-id="${entry.getClassPK()}" data-url="${entry.getUrl()}">
	        <div class="flex-item-center item-img-container">
	            <img alt="" class="item-icon" src="/documents/33300/39232/file.png/c48b31b9-e94a-866a-19d5-f8debacc9ec8"/>
	        </div>
	        <div class="flex-item-expand flex-item-center item-text">
