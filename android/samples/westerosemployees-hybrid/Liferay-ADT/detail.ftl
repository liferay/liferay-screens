<#if entries?has_content>
    ...
    <#if entry.getAssetRenderer().getClassName() == 'com.liferay.blogs.kernel.model.BlogsEntry'>
        ...
        <div class="img-content-blog" style="text-align: center;">
            <img alt="" class="img-blog" id="img-header" src="${entry.getAssetRenderer().getAssetObject().getSmallImageURL(themeDisplay)}" />
        </div> </br>
        <div class="flex-container author-content">
            ...
            <div class="flex-item-expand flex-item-center" style="font-style:normal; margin-left:15px; margin-right:15px">
