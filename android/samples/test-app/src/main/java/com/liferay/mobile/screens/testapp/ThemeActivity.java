...
public abstract class ThemeActivity extends AppCompatActivity {
	...
	private final int[] themes = { R.style.lexicon_theme, R.style.default_theme, R.style.material_theme, R.style.westeros_theme };
	private final int[] colors =
		{ R.color.colorPrimary_lexicon, R.color.colorPrimary_default, R.color.colorPrimary_material, R.color.colorPrimary_westeros };
