...
package com.liferay.mobile.screens.bookmark.interactor.v7;
...
public class BookmarksEntryService extends BaseService {
    ...
    public JSONObject addEntry(long groupId, long folderId, String name, String url, String description,
    ...
    public JSONArray getEntries(long groupId, long folderId, int start, int end, JSONObjectWrapper orderByComparator)
        throws Exception {
        JSONObject _command = new JSONObject();
        ...
        try {
            ...
            mangleWrapper(_params, "orderByComparator",
                "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.bookmarks.model.BookmarksEntry>",
                orderByComparator);
    ...
    public JSONObject updateEntry(long entryId, long groupId, long folderId, String name, String url,
        String description, JSONObjectWrapper serviceContext) throws Exception {
        JSONObject _command = new JSONObject();
