...
public class CommentmanagerjsonwsService extends BaseService {
	...
	public Long addComment(long parentCommentId, String body) throws Exception {
		JSONObject _command = new JSONObject();

		try {
			JSONObject _params = new JSONObject();

			_params.put("parentCommentId", parentCommentId);
	...
	public Long updateComment(String className, long classPK, long commentId, String subject, String body) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getTopLevelThreadCommentsCount(long groupId, String className, long classPK) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/comment.commentmanagerjsonws/get-top-level-thread-comments-count", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
	...
	public Integer getTopLevelThreadCommentsCount(long commentId) throws Exception {
		JSONObject _command = new JSONObject();
