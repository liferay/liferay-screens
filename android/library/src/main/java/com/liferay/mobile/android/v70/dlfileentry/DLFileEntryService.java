...
package com.liferay.mobile.android.v70.dlfileentry;
...
public class DLFileEntryService extends BaseService {
	...
	public JSONArray getFileEntries(long groupId, long folderId, int start, int end, JSONObjectWrapper obc) throws Exception {
		...
		try {
			...
			_params.put("start", start);
			_params.put("end", end);
			mangleWrapper(_params, "obc", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.documentlibrary.model.DLFileEntry>", obc);
