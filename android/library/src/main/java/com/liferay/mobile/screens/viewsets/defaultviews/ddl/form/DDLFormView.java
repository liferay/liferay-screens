...
public class DDLFormView extends ScrollView implements DDLFormViewModel, View.OnClickListener {
	...
	protected void addFieldView(Field field, int position) {
		...
		boolean isCustomLayout = customLayoutIds.containsKey(field.getName());
		layoutId = isCustomLayout ? getCustomFieldLayoutId(field.getName()) : getFieldLayoutId(field.getEditorType());
