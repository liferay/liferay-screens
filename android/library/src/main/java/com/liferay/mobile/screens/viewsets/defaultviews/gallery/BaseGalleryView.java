...
public abstract class BaseGalleryView<H extends BaseListAdapter.ViewHolder, A extends BaseListAdapter<ImageEntry, H>>
	...
	public BaseGalleryView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public BaseGalleryView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	public BaseGalleryView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
