...
public class GetUserInteractor extends BaseRemoteInteractor<GetUserListener, BasicEvent>
{
    ...
    private JSONObject getJSONObject() throws Exception
    {
        ...
        {
            case "userId" : return connector.getUserById(Long.parseLong(textValue));
            case "screenName" : return connector.getUserByScreenName(companyId, textValue);
            case "emailAddress":
            default : return connector.getUserByEmailAddress(companyId, textValue);
        }
    }
