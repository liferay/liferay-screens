...
import com.liferay.mobile.screens.webcontent.display.interactor.WebContentDisplayFromArticleIdCallback;
 ...
 */
public class WebContentDisplayFromArticleIdThreadInteractorImpl
	extends BaseCachedRemoteInteractor<WebContentDisplayListener, WebContentDisplayEvent> {

	public WebContentDisplayFromArticleIdThreadInteractorImpl(int targetScreenletId, OfflinePolicy offlinePolicy) {
...
//			WebContentDisplayEvent myObject = snappyDB.getObject(id, WebContentDisplayEvent.class);
//			onEvent(myObject);
//		}
...
//		DB snappydb = null;
//		try {
//			snappydb = DBFactory.open(LiferayScreensContext.getContext());
//
//
//			snappydb.put(webContentId, event);
//			snappydb.close();
//		}
//		catch (SnappydbException e) {
//			e.printStackTrace();
