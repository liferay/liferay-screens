...
public class DDLFormView extends com.liferay.mobile.screens.viewsets.defaultviews.ddl.form.DDLFormView {
	...
	static {
		...
		LEXICON_LAYOUT_IDS.put(Field.EditorType.SELECT, R.layout.ddlfield_select_default);
		...
		LEXICON_LAYOUT_IDS.put(Field.EditorType.DOCUMENT, R.layout.ddlfield_document_default);
