...
public class DDLFormView extends com.liferay.mobile.screens.viewsets.defaultviews.ddl.form.DDLFormView {
	...
	static {
		...
		LEXICON_LAYOUT_IDS.put(Field.EditorType.RADIO, R.layout.ddlfield_radio_default);
		LEXICON_LAYOUT_IDS.put(Field.EditorType.SELECT, R.layout.ddlfield_text_area_default);
		...
		LEXICON_LAYOUT_IDS.put(Field.EditorType.DOCUMENT, R.layout.ddlfield_text_area_default);
