...
#import "LRAssetTagService_v70.h"

/**
 * @author Bruno Farache
 */
@implementation LRAssetTagService_v70
...
- (NSArray *)getTagsWithGroupId:(long long)groupId name:(NSString *)name start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.asset.model.AssetTag>" wrapper:obc];
