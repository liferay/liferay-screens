...
#import "LRDLFolderService_v70.h"

/**
 * @author Bruno Farache
 */
@implementation LRDLFolderService_v70
...
- (NSArray *)getFoldersWithGroupId:(long long)groupId parentFolderId:(long long)parentFolderId start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.documentlibrary.model.DLFolder>" wrapper:obc];
