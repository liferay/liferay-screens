...
#import "LRContactService_v70.h"

/**
 * @author Bruno Farache
 */
@implementation LRContactService_v70
...
- (NSArray *)getContactsWithClassNameId:(long long)classNameId classPK:(long long)classPK start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.model.Contact>" wrapper:orderByComparator];
