...
#import "LRTrashEntryService_v70.h"

/**
 * @author Bruno Farache
 */
@implementation LRTrashEntryService_v70
...
- (NSDictionary *)getEntriesWithGroupId:(long long)groupId start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.trash.model.TrashEntry>" wrapper:obc];
