...
#import "LRTeamService_v70.h"

/**
 * @author Bruno Farache
 */
@implementation LRTeamService_v70
...
- (NSArray *)searchWithGroupId:(long long)groupId name:(NSString *)name description:(NSString *)description params:(NSDictionary *)params start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.model.Team>" wrapper:obc];
