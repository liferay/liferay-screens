...
#import "LRExportimportService_v70.h"

/**
 * @author Bruno Farache
 */
@implementation LRExportimportService_v70
...
- (NSDictionary *)exportPortletInfoAsFileWithExportImportConfiguration:(LRJSONObjectWrapper *)exportImportConfiguration error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"exportImportConfiguration" className:@"com.liferay.portlet.exportimport.model.ExportImportConfiguration" wrapper:exportImportConfiguration];
