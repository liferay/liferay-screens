...
#import "LRMBMessageService_v70.h"

/**
 * @author Bruno Farache
 */
@implementation LRMBMessageService_v70
...
- (NSDictionary *)getMessageDisplayWithMessageId:(long long)messageId status:(int)status includePrevAndNext:(BOOL)includePrevAndNext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"messageId": @(messageId),
		@"status": @(status),
		@"includePrevAndNext": @(includePrevAndNext)
...
- (void)addMessageAttachmentWithMessageId:(long long)messageId fileName:(NSString *)fileName file:(LRUploadData *)file mimeType:(NSString *)mimeType error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/mbmessage/add-message-attachment": _params};
...
- (void)deleteMessageAttachmentWithMessageId:(long long)messageId fileName:(NSString *)fileName error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/mbmessage/delete-message-attachment": _params};
...
- (void)emptyMessageAttachmentsWithMessageId:(long long)messageId error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/mbmessage/empty-message-attachments": _params};
