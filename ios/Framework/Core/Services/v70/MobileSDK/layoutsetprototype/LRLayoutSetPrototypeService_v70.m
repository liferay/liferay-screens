...
#import "LRLayoutSetPrototypeService_v70.h"

/**
 * @author Bruno Farache
 */
@implementation LRLayoutSetPrototypeService_v70
...
- (NSArray *)searchWithCompanyId:(long long)companyId active:(BOOL)active obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.model.LayoutSetPrototype>" wrapper:obc];
