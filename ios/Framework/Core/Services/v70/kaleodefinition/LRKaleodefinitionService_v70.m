...
#import "LRKaleodefinitionService_v70.h"

/**
 * @author Bruno Farache
 */
@implementation LRKaleodefinitionService_v70
...
- (NSArray *)getKaleoDefinitionsWithStart:(int)start end:(int)end error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/kaleo.kaleodefinition/get-kaleo-definitions": _params};
