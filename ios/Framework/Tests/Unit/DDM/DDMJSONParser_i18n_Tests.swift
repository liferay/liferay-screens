...
class DDLJSONParser_i18n_Tests: XCTestCase {
	...
	func test_ParseElement_ShouldFindFullMatch_WhenExistingCompleteLocaleIsProvided() {
		let fields = DDLJSONParser().parse(booleanFieldWithTranslationsJSON, locale: spanishLocale)
	...
	func test_ParseOption_ShouldFindFullMatch_WhenExistingCompleteLocaleIsProvided() {
		let fields = DDLJSONParser().parse(selectWithTranslatedOptionsJSON, locale: spanishLocale)
	...
	func test_ParseElement_ShouldFindNeutralLanguageMatch_WhenNoExistingCompleteLocaleIsProvided() {
		let fields = DDLJSONParser().parse(booleanFieldWithTranslationsJSON, locale: NSLocale(localeIdentifier: "es_MX"))
	...
	func test_ParseElement_ShouldFindAnyLanguageMatch_WhenNoExistingCompleteLocaleIsProvided() {
		let fields = DDLJSONParser().parse(booleanFieldWithTranslationsJSON, locale: NSLocale(localeIdentifier: "en_GB"))
	...
	func test_ParseOption_ShouldFindNeutralLanguageMatch_WhenNoExistingCompleteLocaleIsProvided() {
		let fields = DDLJSONParser().parse(selectWithTranslatedOptionsJSON, locale: NSLocale(localeIdentifier: "es_MX"))
	...
	func test_ParseElement_ShouldFindDefault_WhenNoExistingCompleteLocaleIsProvided() {
		let fields = DDLJSONParser().parse(booleanFieldWithTranslationsJSON, locale: NSLocale(localeIdentifier: "fr_FR"))

		XCTAssertEqual("Un Booleano para 'es_ES'", fields![0].label)
	}

	func test_ParseOption_ShouldFindDefault_WhenNoExistingCompleteLocaleIsProvided() {
		let fields = DDLJSONParser().parse(selectWithTranslatedOptionsJSON, locale: NSLocale(localeIdentifier: "fr_FR"))
	...
	func test_ParseElement_ShouldFindNeutralLanguageMatch_WhenExistingNeutralLanguageIsProvided() {
		let fields = DDLJSONParser().parse(booleanFieldWithTranslationsJSON, locale: NSLocale(localeIdentifier: "es"))

		XCTAssertEqual("Un Booleano neutro para 'es'", fields![0].label)
	}

	func test_ParseOption_ShouldFindNeutralLanguageMatch_WhenExistingNeutralLanguageIsProvided() {
		let fields = DDLJSONParser().parse(selectWithTranslatedOptionsJSON, locale: NSLocale(localeIdentifier: "es"))
	...
	func test_ParseElement_ShouldFindDefault_WhenNoExistingNeutralLanguageIsProvided() {
		let fields = DDLJSONParser().parse(booleanFieldWithTranslationsJSON, locale: NSLocale(localeIdentifier: "fr"))

		XCTAssertEqual("Un Booleano para 'es_ES'", fields![0].label)
	}

	func test_ParseOption_ShouldFindDefault_WhenNoExistingNeutralLanguageIsProvided() {
		let fields = DDLJSONParser().parse(selectWithTranslatedOptionsJSON, locale: NSLocale(localeIdentifier: "fr"))
	...
	func test_ParseElement_ShouldFindAnyLanguageMatch_WhenNoExistingNeutralLanguageIsProvided() {
		let fields = DDLJSONParser().parse(booleanFieldWithTranslationsJSON, locale: NSLocale(localeIdentifier: "en"))
	...
	func test_ParseOption_ShouldFindAnyLanguageMatch_WhenNoExistingNeutralLanguageIsProvided() {
		let fields = DDLJSONParser().parse(selectWithTranslatedOptionsJSON, locale: NSLocale(localeIdentifier: "en"))
